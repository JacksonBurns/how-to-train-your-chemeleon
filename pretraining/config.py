...
# for training
DROPOUT_FRACTION = 0.7  # see https://doi.org/10.1039/D5DD00369E for better ideas -> e.g. 60% mask = 40% dropout
EPOCHS = 10
PATIENCE = 2
LR_MULTIPLIER = 1.45  # sqrt(8), from: https://arxiv.org/pdf/1705.08741
...
FNN_HIDDEN_LAYERS = 1
FNN_ACTIVATION = "PRELU"  # one of: RELU, LEAKYRELU, PRELU, TANH, ELU
MP_HIDDEN_SIZE = 2_432
MP_DEPTH = 6
